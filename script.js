...
function game() {
    ...
    let finalScore = `${scorePlayer} to ${scoreComputer}`;
    for (let i = 0; i < 5; i++){
        ...
        if (result == 'You win motherfucker!' || result == 'Winner Winner Chicken Dinner' || result == 'You won Mate!' ) {
               ...
               console.log(`${result}! -- Score for Player is ${scorePlayer += 1}`);
             // console.log(result + ' ' + score);
           } else if (result == 'Next time you\'ll have more luck' || result == 'Unlucky' || result == 'You should better quit') {
            
             console.log(`${result}! -- Score for Computer is ${scoreComputer += 1}`);
             //console.log(result + ' ' +  score);
        } else  {
            console.log('Draw')
           // console.log(score);
...
if (scorePlayer > scoreComputer) {
    console.log(`The final score is: ${finalScore}. Player you are outrageous!`);
} else if (scorePlayer < scoreComputer) {
    console.log(`The final score is: ${finalScore}. Embarassing. Computer destroyed you!`);
} else {
    console.log(`The final score is: ${finalScore}. It's just another Draw. Try again`);
};
};
